...
Take an example from [lxr-adminmenu](https://github.com/lxrcore/lxr-adminmenu) how to work with this or the menuv_example.

Edit: 2022-02-18
To use images for the header, create a menu as you normally would. Change the "texture" (default / example / native / lxcore / qbcore) to the wanted one, or add a new image into "assets/img/"
